...
# Define a global counter to keep track of the time elapsed
global_counter = 0

def repeat():
    global currentGreen, currentYellow, nextGreen, global_counter
    ...
    end_time = global_counter
    
    currentYellow = 1   # set yellow signal on
    
    # Print the total number of vehicles that crossed the lane during green signal time with timestamps
    total_crossed = vehicles[directionNumbers[currentGreen]]['crossed']
    print(f"Start Time: {start_time}, End Time: {end_time}, Total vehicles crossed lane {directionNumbers[currentGreen]} during green signal: {total_crossed}")
    
    # reset stop coordinates of lanes and vehicles 
    for i in range(0,3):
        for vehicle in vehicles[directionNumbers[currentGreen]][i]:
            vehicle.stop = defaultStop[directionNumbers[currentGreen]]
            vehicle.crossed = 0  # Reset the crossed attribute for vehicles in this lane
